        ...
        >
                ...
                >
                    ...
                    >
                        ...
                        <div style={styles.headerInfo}>
                            <p>Released: 05/09/2026</p>
                            <p>JWBIOS (C)2026 John Wrexel Antopina</p>
                        </div>
                    </div>
                    <div style={styles.body} className="loading-screen-body">
                        <p>JWA Portfolio Boot Sequence 2026</p>
                        <div style={styles.spacer} />
                        {showBiosInfo && (
                            <>
                                <p>Portfolio Showcase(tm) Candidate Build 1.0</p>
                        ...
                        {showLoadingResources && doneLoading && (
                            <p>
                                ...
                                <b style={styles.green}>
                                    'John Wrexel Antopina Portfolio Showcase'
                                </b>{' '}
                                V1.0
                            </p>
                        )}
            ...
            >
                <div style={styles.startPopup}>
                    ...
                    <div style={styles.spacer} />
                    <div style={styles.spacer} /> */}
                    <p>John Wrexel Antopina Portfolio Showcase</p>
                    {mobileWarning && (
                        <>
                            <br />
                            <b>
