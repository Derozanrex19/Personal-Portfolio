...
export default class MonitorScreen extends EventEmitter {
    ...
    createIframe() {
        ...
        // Use a local portfolio page so the monitor experience can be customized
        // from this repository without depending on a second external project.
        ...
        iframe.title = 'John Wrexel Antopina Portfolio';
